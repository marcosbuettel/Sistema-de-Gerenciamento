<?php
	...
	$idComentarioAtual = $_GET['idComentario'];

	include_once("../Model/modelVerificarCalendario.php");	
	include_once("../Model/modelVerificarComentarioBlocoCalendarioUnico.php");
?>
...
<section class="calendario-wrapper">
				...
				<div class="info-arte">
					...
					<div class="etapas-aprovacao-mobile" style="display: flex; justify-content: space-between;">
						...
						<a href="#" onclick="novoComentario()">
							<div class="box-info-arte" style="background-color: #EAD85B; width: 150px;font-size: 16px; font-weight: bold; position: relative;top: 35%">
								<span>SUGESTÃO</span>
	...
	<div class="janela-editar-comentario">
		...
		<div class="adicionar-comentario-bloco">
			<h2>Escreva seu comentário:</h2>
			<br>
			<form method="POST" action="../Model/modelEditarComentarioBloco.php?idComentario=<?php echo $idComentarioAtual?>">
				<textarea name="comentario-bloco"><?php echo $totalComentarioBlocoCalendarioUnico[0]['descricao_comentario_bloco_calendario']?></textarea>

				<input type="hidden" id="idComentario" readonly>
