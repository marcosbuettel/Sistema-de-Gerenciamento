<?php 
	//PÁGINA PARA EDITAR O BLOCO DO CALENDÁRIO
...
<?php if($_SESSION['tipo-usuario'] == 'adm' or $_SESSION['tipo-usuario'] == 'master'){?>
	...
	<section class="calendario-wrapper">
		...
		<?php 	
			//PARTE ONDE VAI SALVAR NO BANCO AS EDIÇÕES FEITAS
			if(isset($_POST['dia-do-bloco'])){	
				...
				$editarBlocoCalendario = $pdo->prepare("UPDATE bloco_calendario SET tipo_bloco_calendario = '$tipoBloco', dia_bloco_calendario = '$diaDoBloco', mes_bloco_calendario = '$mesBloco', prazo_bloco_calendario = '$prazoBloco', tema_bloco_calendario = '$temaBloco', descricao_bloco_calendario = '$descricaoBloco' WHERE id_bloco_calendario = '$idBlocoCalendario2'");
					...
					<form method="POST">
						...
						<div class="info-cadastro-bloco-calendario-box">	
							<div class="tema-bloco">
								...
								<input name="prazo-arte-bloco" type="date" value="<?php echo $totalBlocoCalendario[0]['prazo_bloco_calendario']?>" required>
							</div>							
							<br>
							<div class="tema-bloco">
								<label>Tema: </label><br>
