...
<!--<section class="calendario-wrapper">
	...
	<div class="janela-descricao-bloco-calendario  janela-cadastro-bloco-calendario-wrapper">
		...
		<div class="cadastrar-arte">
			<form method="POST" action="../Model/modelCadastroArteBloco.php" enctype="multipart/form-data" style="padding: 10px; margin: 0 auto; text-align: center">
				<div style="display: flex; padding: 10px; flex-wrap: wrap;">
					<h3 style="margin: 0 20px">CADASTRAR ARTE:</h3>

					<input type="file" name="fileToUpload[]" id="fileToUpload" multiple="multiple">
					<button style="margin: 0 20px" onclick="enviarArte()">Enviar</button><br>
					
				</div>
				<progress class="progresso-enviar-img"></progress>
			</form>
		</div>
		<br>
		<?php }?>
			...
			<div class="descricao-img-instagram">
				...
				<?php if($totalBlocoCalendario[0]['tipo_bloco_calendario'] == 'story'){?>
					<div class="img-instagram">						
						...
						<?php }?>	
							...
							<a href="../Model/modelExcluirImagemBloco.php?id=<?php echo $idCalendario?>&idB=<?php echo $totalImagemBloco[$i]['id_bloco_calendario']?>&idI=<?php echo $totalImagemBloco[$i]['id_imagem_bloco']?>">
									<div class="acao-imagem-carrossel">
				...
				<?php }else{?>
					...
					<div class="img-instagram">
						...
						<?php }?>	
							...
							<div class="carrossel-instagram-box">
								<?php 
									//SÓ USUARIO 'ADM' E 'MASTER' PODEM CADASTRAR ARTE
									if($_SESSION['tipo-usuario'] == 'adm' or $_SESSION['tipo-usuario'] == 'master'){
								?>
				...
				<div class="info-arte">
					...
					<div style="display: flex; justify-content: space-between;">
						<div>
							<span><b>Prazo:</b> <?php echo formatarData($totalBlocoCalendario[0]['prazo_bloco_calendario'])?></span>
							
						</div>

						<div>
							<span><b>Data Postagem:</b> </span>
...
<script type="text/javascript">
	...
	animatethis($('.carrossel-instagram'), 6500);
	...
	function enviarArte(){
		$('.progresso-enviar-img').css('display', 'block');
	}
