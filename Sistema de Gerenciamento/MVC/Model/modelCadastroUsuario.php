<?php 
	...
	$cadastrarUsuario = $pdo->prepare("INSERT INTO usuarios (nome_usuario, imagem_usuario, senha_usuario, tipo_usuario, nome_cliente) VALUES ('$nomeUsuario', '$linkImg','$senhaUsuario', '$tipoUsuario','$nomeCliente')");
