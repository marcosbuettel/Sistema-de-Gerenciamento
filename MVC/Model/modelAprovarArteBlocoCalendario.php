<?php 
	//ARQUIVO QUE SALVA NO BANCO DE DADOS A APROVAÇÃO DO CLIENTE
	//EM CADA ETAPA DO BLOCO DO CALENDARIO
	...
	//VERIFICANDO QUAL ETAPA ESTÁ SENDO APROVADA PARA PODER
	//MANDAR A NOTIFICAÇÃO
	//$tipoAProvacao -> [0 - TEMA], [1 - ARTE], [2 - LEGENDA]
	if($tipoAprovacao == 0){
